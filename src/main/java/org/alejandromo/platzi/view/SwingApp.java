package org.alejandromo.platzi.view;
...
public class SwingApp extends JFrame {
    ...
    private void agregarEmpleado() throws SQLException {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, "Empleado cargado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void actualizarEmpleado() {
        ...
        if (empleadoIdStr != null) {
            try {
              ...
              if (empleado != null) {
                  // Crear un formulario con los datos de los empleados
